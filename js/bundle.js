  ...
  function bindpostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_10__.postData)('http://localhost:3000/requests', json).then(function (data) {
        ...
        statusMessage.remove(); // удаляем текст
      })["catch"](function () {
...
function slider(_ref) {
  ...
  var indicators = document.createElement('ol'),
      dots = [];
  indicators.classList.add('carousel-indicators'); // indicators.style.cssText = `
  // 	position: absolute;
  // 	right: 0;
  // 	bottom: 0;
  // 	left: 0;
  ...
  for (var i = 0; i < slides.length; i++) {
    ...
    dot.classList.add('dot'); // dot.style.cssText = `
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      var clideTo = e.target.getAttribute('data-slide-to');
      slideIndex = clideTo;
...
function tabs(tabsSelector, tabsContentSelector, tabsParentsSelector, activClass) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__.default)('.timer', '2020-10-30');
